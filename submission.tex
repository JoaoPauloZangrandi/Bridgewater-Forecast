...
\definecolor{ink}{HTML}{13222F}
\definecolor{muted}{HTML}{65727B}
\definecolor{blue}{HTML}{2F6F91}
\definecolor{teal}{HTML}{2F8077}
\definecolor{gold}{HTML}{B47E24}
\definecolor{red}{HTML}{A84F45}
\definecolor{rule}{HTML}{D8DDE0}
...
\newif\ifdraft
\drafttrue
\fancyhead[L]{\scriptsize\color{muted}\textbf{FORECASTING THE FUTURE 2026}}
\fancyhead[R]{\scriptsize\color{muted}JOAO PAULO ZANGRANDI}
\fancyfoot[C]{\scriptsize\color{muted}\thepage\ /\ 10}
\ifdraft
  \fancyfoot[L]{\scriptsize\color{red}\textbf{AUTHOR REVIEW DRAFT --- NOT FOR SUBMISSION}}
\fi
\renewcommand{\headrulewidth}{0.35pt}
\renewcommand{\footrulewidth}{0pt}
\setlength{\headheight}{13pt}

\titleformat{\section}{\color{ink}\Large\bfseries}{}{0pt}{}
\titleformat{\subsection}{\color{ink}\normalsize\bfseries}{}{0pt}{}
\titlespacing*{\section}{0pt}{2pt}{4pt}
\titlespacing*{\subsection}{0pt}{5pt}{1pt}

\newcommand{\src}[1]{\textsuperscript{\color{blue}[#1]}}
\newcommand{\eyebrow}[1]{{\footnotesize\color{blue}\bfseries\MakeUppercase{#1}}}
\newcommand{\forecast}[4]{%
  \noindent
  \begin{minipage}[t]{0.105\textwidth}
    \vspace{0pt}
    {\scriptsize\color{muted}\bfseries #1}\\[-1pt]
    {\LARGE\color{#4}\bfseries #2}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.865\textwidth}
    \vspace{1pt}
    #3
  \end{minipage}
  \par\vspace{5.4pt}\color{rule}\hrule\color{ink}\vspace{5.4pt}
}
\newcommand{\tighthead}[1]{\vspace{2pt}{\color{ink}\bfseries #1}\par\vspace{1pt}}
...
{\fontsize{22}{24}\selectfont\bfseries The Assured-Access Economy\par}
\vspace{1pt}
{\large\color{muted}Forecasting the collision of abundant intelligence and scarce complements}
...
\vspace{4pt}
\forecast{F01}{75\%}{There is a 75\% chance that, by December 31, 2029, METR will report a 50\% task-completion time horizon of at least 168 human-expert hours for a publicly available general-purpose AI agent.}{blue}

\forecast{F02}{64\%}{There is a 64\% chance that at least 35\% of U.S. employer firms will report using AI in any business function in the final 2028 Business Trends and Outlook Survey estimate.}{teal}

\forecast{F03}{46\%}{There is a 46\% chance that U.S. nonfarm-business labor productivity will grow by more than 2.25\% annualized from 2026Q4 through 2030Q4.}{gold}

\forecast{F04}{58\%}{There is a 58\% chance that Alphabet, Amazon, Meta, and Microsoft will report more than \$1 trillion of aggregate capital expenditure in calendar 2028.}{red}

\forecast{F05}{52\%}{There is a 52\% chance that data centers will consume more than 12\% of total U.S. electricity in calendar 2030.}{teal}

\forecast{F06}{78\%}{There is a 78\% chance that at least three independent foundry operators will be conducting commercial high-volume production on company-designated 2-nanometer-or-smaller process nodes in the United States by December 31, 2030.}{blue}

\vfill
{\scriptsize\color{muted}Forecast colors identify analytical clusters, not confidence bands.}
...
{\large\bfseries Modern Mercantilism and the physical stack}
\vspace{5pt}

\forecast{F07}{39\%}{There is a 39\% chance that at least four facilities selected under the EU AI Gigafactories initiative will be operational and accepting compute workloads from external users by December 31, 2029.}{red}

\forecast{F08}{83\%}{There is an 83\% chance that the average top-country refining share across copper, lithium, nickel, cobalt, graphite, and manganese will remain above 65\% in 2030.}{gold}

\forecast{F09}{68\%}{There is a 68\% chance that China's annual goods trade surplus will exceed \$1 trillion in at least two of the three calendar years from 2027 through 2029.}{red}

\forecast{F10}{57\%}{There is a 57\% chance that no more than 65\% of global merchandise trade will be conducted on WTO most-favored-nation terms at year-end 2029.}{blue}

\forecast{F11}{82\%}{There is an 82\% chance that the WTO Appellate Body will still lack the minimum three sitting members needed to hear an appeal on December 31, 2029.}{gold}

\forecast{F12}{72\%}{There is a 72\% chance that the annual U.S. effective tariff rate, measured as duties collected divided by customs value, will average at least 8\% across calendar years 2027 through 2029.}{red}
...
{\fontsize{20}{22}\selectfont\bfseries Intelligence gets cheaper; assurance gets dearer\par}
\vspace{3pt}

\textbf{Thesis.} AI is making cognition abundant faster than economies can make
its complements abundant. Modern Mercantilism is the political response to
that mismatch: governments pay a premium to control power, chips, minerals,
data, capital, and industrial know-how inside trusted jurisdictions. The
interaction creates an \textit{assured-access economy}. It fragments strategic
nodes, not the global network; raises investment before it raises measured
productivity; and rewards control of bottlenecks more reliably than ownership
of any single model.

Bridgewater's useful starting point is that national security now enters
production functions directly.\src{3,5} My departure is to treat ``AI'' and
``mercantilism'' as a coupled system rather than two resource grabs. Cheap
...
{\Large\bfseries From comparative advantage to assured access}
...
\vspace{3pt}
\begin{tabularx}{\textwidth}{@{}>{\bfseries\color{blue}}p{0.19\textwidth}X>{\bfseries\color{red}}p{0.19\textwidth}X@{}}
What scales quickly & software capability, model access, trade rerouting &
What scales slowly & grids, refineries, skills, institutions\\
What policy can buy & redundant plant, inventory, demand guarantees &
What policy cannot buy & tacit know-how, utilization, trust, productivity\\
\end{tabularx}
...
{\Large\bfseries Distribution, scenarios, and what would prove this wrong}
...
{\Large\bfseries Method: calibrated judgment under correlated uncertainty}
...
countercase. I reconciled them in log-odds space with a robust center, then
forced cross-forecast consistency through the three macro scenarios below.
This mirrors the useful elements of Bridgewater AIA Labs' search--reconcile--
calibrate process without pretending that a small bespoke set supplies a
statistical calibration sample.\src{6}
...
The final probability is the 25/50/25 scenario-weighted mean, rounded to the
nearest point. The scenario conditionals are judgments, not fitted likelihoods.
This distinction matters: fake precision would be worse than transparent
structure.
...
{\Large\bfseries AI: capability outruns diffusion; diffusion outruns GDP}
...
{\Large\bfseries The physical stack: capacity is not sovereignty}
...
\vspace{4pt}
\begin{tabularx}{\textwidth}{@{}>{\bfseries}p{0.20\textwidth}XXX@{}}
\toprule
...
{\Large\bfseries Trade: rerouting is not rebalancing}
...
\tighthead{Joint interpretation}
\begin{tabularx}{\textwidth}{@{}>{\bfseries}p{0.23\textwidth}X@{}}
\toprule
Observed outcome & What it would mean\\
\midrule
F09 Yes, F10/F12 No & Chinese imbalance persisted, but rerouting and domestic
weakness mattered more than global rule fragmentation.\\
F10/F12 Yes, F09 No & Protection and trusted lanes worked faster than China's
domestic rebalancing failed.\\
F11 Yes, F10 No & Institutional paralysis persisted while firms and states
adapted without further aggregate discrimination.\\
All four Yes & The assured-access regime became self-reinforcing: imbalance,
discrimination, tariffs, and weak adjudication moved together.\\
\bottomrule
\end{tabularx}
...
{\Large\bfseries Resolve the words, not the narrative}
\vspace{2pt}

{\fontsize{7.4}{8.65}\selectfont
\begin{multicols}{2}
\raggedcolumns
...
\textbf{[7]} METR, \href{https://metr.org/time-horizons/}{Task-Completion Time Horizons}, May 2026.
...
\textbf{[20]} WTO, \href{https://www.wto.org/english/news_e/news26_e/stat_19mar26_329_e.htm}{Global Trade Outlook and Statistics}, Mar.\ 2026; WTO MFN-share dataset.
