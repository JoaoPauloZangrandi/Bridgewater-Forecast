...
\usepackage[letterpaper,top=0.58in,bottom=0.54in,left=0.68in,right=0.68in]{geometry}
...
\definecolor{ink}{HTML}{202829}
\definecolor{muted}{HTML}{687170}
\definecolor{accent}{HTML}{145C58}
\definecolor{cover}{HTML}{173F3D}
\definecolor{copper}{HTML}{A36A32}
\definecolor{draftred}{HTML}{A2473D}
\definecolor{rule}{HTML}{D5DCDA}
\definecolor{pale}{HTML}{EAF0EE}
...
\newif\ifdraft
\drafttrue
\fancyhead[L]{\sffamily\fontsize{7.2}{8}\selectfont\color{muted}\textbf{FORECASTING THE FUTURE 2026}\quad/\quad RESEARCH NOTE}
\fancyhead[R]{\sffamily\fontsize{7.2}{8}\selectfont\color{muted}INFORMATION CUTOFF: JULY 30, 2026}
\fancyfoot[R]{\sffamily\scriptsize\color{muted}\thepage\ /\ 10}
\ifdraft
  \fancyfoot[L]{\sffamily\scriptsize\color{draftred}\textbf{AUTHOR REVIEW DRAFT --- NOT FOR SUBMISSION}}
\fi
...
\newcommand{\src}[1]{\textsuperscript{\color{accent}[#1]}}
\newcommand{\eyebrow}[1]{{\sffamily\fontsize{7.8}{9}\selectfont\color{accent}\bfseries\MakeUppercase{#1}}}
\newcommand{\pagetitle}[1]{{\fontsize{20}{22}\selectfont\bfseries #1\par}\vspace{1pt}\color{accent}\hrule height 0.8pt\color{ink}\vspace{4pt}}
\newcommand{\forecast}[5]{%
  \noindent
  \begin{minipage}[t]{0.108\textwidth}
    \vspace{0pt}
    {\sffamily\fontsize{7}{8}\selectfont\color{accent}\bfseries #1}\\[-2pt]
    {\sffamily\fontsize{20}{20}\selectfont\color{accent}\bfseries #2}\\[-2pt]
    {\sffamily\fontsize{5.9}{6.5}\selectfont\color{muted}\bfseries\MakeUppercase{#3}}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.862\textwidth}
    \vspace{2pt}
    #4
  \end{minipage}
  \par\vspace{3.8pt}\color{rule}\hrule height 0.45pt\color{ink}\vspace{3.8pt}
}
\newcommand{\tighthead}[1]{\vspace{4pt}{\sffamily\fontsize{9.4}{10.8}\selectfont\color{ink}\bfseries #1}\par\vspace{1pt}}
\newcommand{\numberedhead}[2]{\vspace{5pt}{\sffamily\fontsize{8}{9}\selectfont\color{accent}\bfseries #1\quad}{\sffamily\fontsize{10}{11.5}\selectfont\color{ink}\bfseries #2}\par\vspace{1pt}}
\newcommand{\exhibithead}[1]{\vspace{3pt}{\sffamily\fontsize{8}{9}\selectfont\color{accent}\bfseries\MakeUppercase{#1}}\par\vspace{2pt}\color{accent}\hrule height 0.65pt\color{ink}\vspace{3pt}}
...
\noindent\colorbox{cover}{\parbox{\dimexpr\textwidth-2\fboxsep\relax}{
  \vspace{8pt}
  {\sffamily\fontsize{8}{9}\selectfont\color{white}\bfseries FORECASTING THE FUTURE 2026\quad/\quad AUTHOR REVIEW DRAFT\par}
  \vspace{9pt}
  {\sffamily\fontsize{25}{28}\selectfont\color{white}\bfseries The Assured-Access Economy\par}
  \vspace{3pt}
  {\sffamily\fontsize{12}{14}\selectfont\color{white}Abundant intelligence meets scarce, strategic complements\par}
  \vspace{12pt}
  {\sffamily\fontsize{7.5}{9}\selectfont\color{white}JOAO PAULO ZANGRANDI\hfill Information cutoff: July 30, 2026\par}
  \vspace{7pt}
}}
\color{copper}\hrule height 2.2pt\color{ink}
\vspace{7pt}
...
\vfill
{\color{accent}\hrule height 0.8pt}\vspace{3pt}
{\sffamily\scriptsize\color{ink}
  ...
  fragment before global trade collapses.
}
...
{\fontsize{17}{19}\selectfont\bfseries Six forecasts on the physical stack and the trade regime\par}
\vspace{3pt}\color{accent}\hrule height 0.8pt\color{ink}\vspace{5pt}
...
{\fontsize{13.1}{15.5}\selectfont\bfseries My highest-conviction claim is not
that AI makes everything scarce. It is that AI changes which scarcities are
worth insuring.\par}
\vspace{2pt}
Cognition is
...
\exhibithead{Exhibit 2 / The assured-access feedback loop}
\begin{center}
\includegraphics[width=0.98\textwidth]{generated/causal_loop.png}
\end{center}
\vspace{-5pt}
...
\numberedhead{01}{States target chokepoints, not autarky}
...
\vfill
\numberedhead{02}{Trade balances and capital balances are the same transaction}
...
\vfill
\numberedhead{03}{Industrial policy buys capacity more readily than capability}
...
\vfill
\numberedhead{04}{The AI capex boom is simultaneously demand and supply policy}
...
\color{accent}Scales quickly & software capability, model access, trade rerouting &
\color{ink}Scales slowly & grids, refineries, skills, institutions\\
\color{copper}Policy can buy & redundant plant, inventory, demand guarantees &
...
\vspace{0pt}
\tighthead{Who wins}
\begin{itemize}[leftmargin=1.0em,itemsep=2.5pt,topsep=1pt]
  ...
  \item \textbf{Power-rich and resource-rich middle powers:} reliable energy,
  minerals, permitting, and geopolitical optionality gain value as firms pay
  for jurisdictional diversification.
\end{itemize}
\end{minipage}\hfill
\begin{minipage}[t]{0.485\textwidth}
\vspace{0pt}
...
\begin{itemize}[leftmargin=1.0em,itemsep=2.5pt,topsep=1pt]
  ...
  ladders, and gains captured by capital and complementary experts. Evidence
  shows exposure and slower young-worker hiring, not mass displacement.\src{10}
  \item \textbf{Consumers and taxpayers in bottleneck jurisdictions} fund
  subsidies and bear tariff incidence. Capacity creation and lower real income
  can occur together.
...
\textbf{\color{accent}Resolution protocol.} Equality follows the sentence
...
\textbf{\color{accent}Selected sources.}
...
\vfill
\textbf{\color{draftred}Draft governance note.} The entrant must independently
